...
import { create } from "@/actions/exames";
        ...
        <>
            ...
            <main className="bg-slate-900 mt-10 p-12 rounded-xl max-w-lg m-auto">
                ...
                <form action={handleSubmit}>
                    ...
                    <InputText name="tipo" id="tipo" label="tipo"/>
                    <InputText name="data" id="data" label="data"/>
                    <InputText name="resultado" id="resultado" label="resultado"/>
                    <InputText name="icone" id="icone" label="ícone" />

                    <div className="flex justify-around mt-4">
                        <Button href="/exames" variant="secundary" icon={<ArrowLeftIcon className="h-6 w-6" />}>
                            Cancelar
                        </Button>
